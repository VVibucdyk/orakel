...
<div class="card-profile">
        ...
        <input type="hidden" id="uraa_code" value="<?= $IDKu ?>">
            ...
            <div class="fields">
                ...
                <div class="field">
                    ...
                    <textarea name="edit_bio" id="edit_bio" rows="4" placholder="Masukanbio baru" value="<?= $UsernameKu ?>"></textarea>
                </div>
            </div>
            <div class="actions">
                <li>
 ...
 <script>
     $('#edit-profil').ready(function() {

        $('#nama').val("<?= $NamaKu ?>");
        $('#username').val(<?= $UsernameKu ?>);
        $('#tgllahir').val(<?= $TglLahirKu ?>);
        $('#tgllahir').val(<?= $TglLahirKu ?>);
