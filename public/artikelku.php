        ...
        <?php foreach ($ArtikelKu as $index => $row) { ?>
            <div class="article-card article-id-<?= $row['kode_artikel'] ?>">
                ...
                <div class="article-content">
                    ...
                    <p class="article-text"><?= strlen(strip_tags($row['isi_artikel'])) < 260 ? strip_tags($row['isi_artikel']) : substr(strip_tags($row['isi_artikel']), 0, strpos(strip_tags($row['isi_artikel']), ' ', 260)); ?> . . .</p>
