    ...
    foreach ($list_artikel['list_artikel'] as $key => $value) : ?>
        ...
        <div class="article-card">
            ...
            <div class="article-content">
                ...
                <p class="article-text"><?= strlen(strip_tags($value['isi_artikel'])) < 260 ? strip_tags($value['isi_artikel']) : substr(strip_tags($value['isi_artikel']), 0, strpos(strip_tags($value['isi_artikel']), ' ', 260)); ?> . . .</p>
